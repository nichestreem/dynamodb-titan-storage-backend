...
//https://github.com/buka/titan/blob/master/src/main/java/com/thinkaurelius/titan/diskstorage/dynamodb/DynamoDBClient.java#L29
    public static final ConfigOption<Boolean> DYNAMODB_FORCE_CONSISTENT_READ = new ConfigOption<Boolean>(DYNAMODB_CONFIGURATION_NAMESPACE, "force-consistent-read", //
    ...
    public static final ConfigOption<Long> DYNAMODB_CLIENT_CONN_TTL = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "connection-ttl", //
    ...
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_MAX_CONN = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "connection-max", //
        "The maximum number of allowed open HTTP connections.", //
        ConfigOption.Type.MASKABLE, ClientConfiguration.DEFAULT_MAX_CONNECTIONS);
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_MAX_ERROR_RETRY = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "retry-error-max", //
    ...
    public static final ConfigOption<Boolean> DYNAMODB_CLIENT_USE_GZIP = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "use-gzip", //
        "Sets whether gzip compression should be used.", //
        ConfigOption.Type.MASKABLE, ClientConfiguration.DEFAULT_USE_GZIP);
    public static final ConfigOption<Boolean> DYNAMODB_CLIENT_USE_REAPER = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "use-reaper", //
    ...
    public static final ConfigOption<String> DYNAMODB_CLIENT_USER_AGENT = new ConfigOption<>(DYNAMODB_CLIENT_NAMESPACE, "user-agent", //
    ...
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_SOCKET_BUFFER_RECV_HINT = new ConfigOption<>(DYNAMODB_CLIENT_SOCKET_NAMESPACE, "buffer-recv-hint", //
        "The optional size hints (in bytes) for the low level TCP receive buffer.", //
        ConfigOption.Type.MASKABLE, 1048576);
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_SOCKET_TIMEOUT = new ConfigOption<>(DYNAMODB_CLIENT_SOCKET_NAMESPACE, "timeout", //
    ...
    public static final ConfigOption<Boolean> DYNAMODB_CLIENT_SOCKET_TCP_KEEP_ALIVE = new ConfigOption<>(DYNAMODB_CLIENT_SOCKET_NAMESPACE, "tcp-keep-alive", //
        "Sets whether or not to enable TCP KeepAlive support at the socket level. Not used at the moment.", //
        ConfigOption.Type.MASKABLE, false);

    public static final ConfigOption<Integer> DYNAMODB_CLIENT_EXECUTOR_CORE_POOL_SIZE = new ConfigOption<>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "core-pool-size", //
    ...
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_EXECUTOR_MAX_POOL_SIZE = new ConfigOption<>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "max-pool-size", //
    ...
    public static final ConfigOption<Long> DYNAMODB_CLIENT_EXECUTOR_KEEP_ALIVE = new ConfigOption<Long>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "keep-alive", //
...
//https://github.com/buka/titan/blob/master/src/main/java/com/thinkaurelius/titan/diskstorage/dynamodb/DynamoDBClient.java#L29
    ...
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_EXECUTOR_QUEUE_MAX_LENGTH = new ConfigOption<Integer>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "max-queue-length", //
    ...
    public static final ConfigOption<Long> DYNAMODB_INITIAL_RETRY_MILLIS = new ConfigOption<>(DYNAMODB_CONFIGURATION_NAMESPACE, "initial-retry-millis",
        ...
        Type.MASKABLE, 25L);
    public static final ConfigOption<Double> DYNAMODB_CONTROL_PLANE_RATE = new ConfigOption<>(DYNAMODB_CONFIGURATION_NAMESPACE, "control-plane-rate",
        "The maximum rate at which control plane requests (CreateTable, UpdateTable, DeleteTable, ListTables, DescribeTable) are issued.",
        Type.MASKABLE, 10.0);

    public static final ConfigOption<Integer> DYNAMODB_CLIENT_EXECUTOR_MAX_CONCURRENT_OPERATIONS = new ConfigOption<>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "max-concurrent-operations", //
    ...
    public static final ConfigOption<String> DYNAMODB_CREDENTIALS_CLASS_NAME = new ConfigOption<>(DYNAMODB_CLIENT_CREDENTIALS_NAMESPACE, "class-name", //
    ...
    public static final ConfigOption<String[]> DYNAMODB_CREDENTIALS_CONSTRUCTOR_ARGS = new ConfigOption<>(DYNAMODB_CLIENT_CREDENTIALS_NAMESPACE, "constructor-args", //
